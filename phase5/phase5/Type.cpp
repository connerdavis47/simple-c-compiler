...
Type::Type() : _specifier("error"), _kind(ERROR) {}
...
bool Type::isSimple() const { return _kind == SIMPLE; }
...
const string &Type::specifier() const { return _specifier; }
...
unsigned Type::indirection() const { return _indirection; }
...
bool Type::isScalar() const { return isNumeric() || isPointer(); }
